...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
      "Karla, quiero que sepas que te amo con cada latido de mi corazón 💜",
      canvas.width / 2,
      canvas.height / 2
    );
  ...
  if (frameNumber > 600 && frameNumber < 900) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        ["Eres lo mas bonito que me ha pasado en la vida, eres mi bendición"],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
        lineHeight
  ...
  if (frameNumber > 1200 && frameNumber < 1500) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "A Dios le pido que me de vida y salud para poder hacerte la mujer mas feliz del mundo",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 1800 && frameNumber < 2100) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "Estoy muy feliz de que estemos cumpliendo 11 mesecitos juntos",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          ...
          "besarte despacito, abrazarte fuerte, acariciarte",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
      ...
      context.fillText(
        "Quiero estar a tu lado todos los días de mi vida",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber > 3000 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "Te amo mas de lo que te puedes llegar a imaginar,",
          "eres la niña de mis ojos, el amor de mi vida...",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
      ...
      context.fillText(
        "Te amo mas de lo que te puedes llegar a imaginar, eres la niña de mis ojos, el amor de mi vida...",
        canvas.width / 2,
        canvas.height / 2
      );
    }
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          ...
          "amo todo de ti, amo cada segundo contigo",
        ],
        canvas.width / 2,
        canvas.height / 2 + 70,
        fontSize,
      ...
      context.fillText(
        "Eres todo lo que quiero en esta vida, amo todo de ti, amo cada segundo contigo",
        canvas.width / 2,
        canvas.height / 2 + 50
      );
    }
  ...
  if (frameNumber >= 3600 && frameNumber < 99999) {
    ...
    context.fillText(
      "Te amo baby, feliz 11 meses juntitos ❤️",
      canvas.width / 2,
      canvas.height / 2 + 120
    );
